    ...
    <div className='overflow-x-hidden'>
      ...
      <div className='max-w-[1440px] mx-auto'>
        <section className='font-whyte px-[80px] xl:px-[25px] sm:px-[25px] xm:px-[16px] relative bg-[#F9FBFF]'>
          ...
          <div className={`z-[1] absolute w-[205px] lgx:w-[189px] sm:w-[117.32px] px-[18px] lgx:px-[10px] py-[16px] lgx:py-2 rounded-[4px] border-[0.6px] bg-[#fff] border-[#E4E7EC] shadow-def transition-all duration-1000 ease-in-out ${load? 'top-[120px] xxl:top-[120px] sm:top-[540px] xxm:top-[560px] sxm:top-[650px] right-[463px] xxl:right-[400px] xl:right-[390px] lgx:right-[350px] lg:right-[330px] md:right-[250px] sm:right-[350px] xm:right-[240px] xxm:right-[220px] sxm:right-[150px]': 'top-[81px] 1xl:top-[60px] xxl:top-[70px] sm:top-[510px] xm:top-[560px] xxm:top-[570px] xxxm:top-[520px] xxxxm:top-[570px] sxm:top-[630px] right-[623px] 1xl:right-[520px] xxl:right-[520px] xl:right-[480px] lgx:right-[400px] lg:right-[400px] md:right-[300px] sm:right-[410px] xm:right-[290px] xxm:right-[230px] xxxm:right-[280px] xxxxm:right-[250px] sxm:right-[200px]'}`}>
                            ...
                            <div className='w-[800px] 1xl:w-[680px] xxl:w-[610px] lgx:w-[570px] lg:w-[470px] md:w-[390px] sm:w-[100%] px-[64px] 1xl:px-[40px] lg:px-[20px] sm:px-[16px] py-[108px] sm:pt-[29.73px] sm:pb-[36.27px] sm:order-2'>
                              ...
                              <div className='flex sm:justify-center gap-4'>
                                {[...Array(testimonials.length).keys()].map((_, i) => (
                                  <div
                                    key={i}
                                    className={`w-[10px] h-[10px] rounded-[6px] ${dotPosition === i ? 'bg-[#fff]' : 'bg-[#667085]'}`}
