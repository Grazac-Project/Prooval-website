...
const Privacy = () => {
  return (
    <>
      <Navbar />
      <div className="bg-[#EFF6FF] py-[64px] md:py-[32px]">
        <div className=" w-[1024px]  lgx:w-[95%] sm:w-full mx-auto  bg-[#ffff] rounded-b-2xl ">
          ...
          <div className="p-[44px] sm:p-[11px]">
            <p className="text-[14px] mb-[16px] md:mb-[16px] sm:mb-[8px] font-onest leading-[24px] text-[#4F4F4F]">
              This Privacy Policy describes how HacktheJobs ("we", "our", or
            ...
            <div>
              ...
              <div className="flex gap-[12px]">
                ...
                <p className="text-[14px] mb-[16px] md:mb-[16px] sm:mb-[8px] font-onest leading-[24px] text-[#4F4F4F]">
                  ...
                  your name, email address, and professional information.
                </p>
              </div>
              <div className="flex gap-[12px]">
                <span className="text-[16px] font-onest leading-[27px] text-[#000000]">
                ...
                <p className="text-[14px] mb-[26px] md:mb-[16px] sm:mb-[8px] font-onest leading-[24px] text-[#4F4F4F]">
                  Usage Data: We collect information on how you interact with
                  our service, including access times, pages viewed, and
                  features used.
                </p>
              </div>
            </div>
            <div className="mb-[16px] md:mb-[16px] sm:mb-[8px]">
              <h4 className="text-[18px] mb-[8px] font-onest font-700 leading-[30px] text-[#121927]">
              ...
              <>
                ...
                <li className="text-[14px]  pl-[14px] font-onest leading-[24px] text-[#4F4F4F]">
            ...
            <div className="mb-[16px] md:mb-[16px] sm:mb-[8px]">
              ...
              <>
                ...
                <li className="text-[14px]  pl-[14px] font-onest leading-[24px] text-[#4F4F4F]">
                  Law enforcement or other government agencies, as required by
                  law.
                </li>
              </>
            </div>
