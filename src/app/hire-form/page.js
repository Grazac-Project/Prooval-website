    ...
    <section className='font-whyte' >
      ...
      <div className='px-[80px] xl:px-[25px] xm:px-[16px]'>
        ...
        <form className='font-inter w-[80%] md:w-[90%] xm:w-[100%] mx-auto' onSubmit={handleSubmit}>
          <div className='flex xm:flex-col justify-between xm:justify-around mb-[24px]' onClick={handleCloseCheckbox}>
            ...
            <div className='flex flex-col w-[48%] xm:w-[100%] gap-[6px]' onClick={handleCloseCheckbox}>
          ...
          <div className='relative' >
            <div className='flex flex-col w-[100%] gap-[6px] mb-[24px]' onClick={handleShowCheckbox}>
                ...
                {showCheckbox ? <IoIosArrowUp className='absolute right-[14px] top-[50px] text-[13.31px] text-[#909090] transform-translate-y-1/2'  />:<IoIosArrowDown className='absolute right-[14px] top-[50px] text-[13.31px] text-[#909090] transform-translate-y-1/2'/> }
            </div>
            {showCheckbox && <div className='z-10 w-[410px] sm:w-[90%] p-[24px] rounded-[8px] border-[1px] border-[#EAEAEA] shadow-footerInput bg-[#fff] absolute right-[0] top-[80px]'>
                <div className='mb-[24px]'>
                  <div className='flex items-center gap-[8px] py-[10px] border-b-[1px] border-b-[#EAEAEA]'>
                    ...
                    <label htmlFor='backend' className='font-regular text-[16px] leading-[20px] text-[#334155]'>Back-end Developer</label>
                  </div>
                  <div className='flex items-center gap-[8px] py-[10px] border-b-[1px] border-b-[#EAEAEA]'>
                    ...
                    <label htmlFor='frontend' className='font-regular text-[16px] leading-[20px] text-[#334155]'>Front-end Developer</label>
                  </div>
                  <div className='flex items-center gap-[8px] py-[10px] border-b-[1px] border-b-[#EAEAEA]'>
                    <input id='MobileAppDeveloper' type='checkbox' name='role' value='MobileAppDeveloper' onChange={handleChange} onBlur={handleBlur} className='w-[20px] h-[20px] text-[#1453FF]'/>
              ...
              <div className='flex flex-wrap gap-[5px] mb-[24px]'>
                {
                  ...
                  (values.role).map((ele, i) => (
                    <div key={i} className='flex items-center w-[24%] lgx:w-[32%] sm:w-[49%] mb-[5px] border-[1px] border-[#D0D5DD] rounded-[8px] shadow-footerInput px-[16px] md:px-[10px] py-[5px] xm:py-[4px]'>
                      ...
                      <span className=' text-[24px] sm:text-[20px] text-[#909090] cursor-pointer' onClick={() => handleRemoveOption(i)}>&times;</span>
                    </div>
                  ))
                }
              </div>
          ...
          <div className='flex flex-col w-[100%] gap-[6px] mb-[32px]' onClick={handleCloseCheckbox}>
