...
const Signup = () => {
  ...
  return (
    <>
        ...
        <section className='font-whyte py-[20px] xm:py-[0px] xxl:py-7 gap-[80px] bg-[#EFF6FF] '>
            <div className='w-[616px] md:w-[90%] xm:w-[100%] bg-[#fff] p-[32px] sm:p-[16px] rounded-[8px] mx-auto py-5'>
                ...
                <button onClick={googleLoginHandler} className='flex justify-center items-center w-[100%] text-[#2A2A2A] text-[16px] leading-[19.36px] font-medium rounded-[8px] border-[1px] border-[#EAEAEA] h-[47px]'><FcGoogle className='mr-[0.5px] text-[20px]'/> Signup with Google</button>
