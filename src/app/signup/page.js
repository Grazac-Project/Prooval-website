    ...
    <div className="min-h-screen bg-[#EFF6FF] xm:bg-[#fff]">
      <div>
        ...
        <section className="font-onest py-[65px] xm:py-[0px]">
          {/* <section className='font-onest flex justify-center items-center h-full'> */}
            ...
            <div>
              ...
              >
                <div
                  ...
                  className="bg-[#fff] px-[48px] py-[29px] mb-[28px] rounded-[8px] cursor-pointer border-[1px]  border-[#EAEAEA] flex justify-center items-center gap-[12px]"
