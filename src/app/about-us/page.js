    ...
    <>
      ...
      <div className={Classes.about}>
        ...
        <div className="w-[95%] mx-auto pl-5 md:pl-[1px] mt-[48px] sm:mt-[24px] ">
          <h1 className="font-satoshi text-[54px] sm:text-[40px] leading-[60px] sm:leading-12 font-500">
            Positioning yourself for growth
          </h1>
          <p className=" font-satoshi text-[16px] leading-[20.8px] font-400 my-6 ">
            Join thousands of professionals growing their impact and income with
            Prooval.
          </p>
        </div>
        ...
        <Image
          src="https://res.cloudinary.com/grazac/image/upload/v1760741623/prooval%20professional/about-us-min_m8yxai.png"
          alt="img"
          width={1440}
          height={600}
        />
      </div>
      <div className={`${Classes.mission} font-satoshi`}>
        <h4>Our Mission </h4>
        <p>
          Our mission is to make it simple for experts to share what they know
          and for people to connect with them through seamless, personalized
          interactions that feel easy and meaningful.
        </p>
      </div>
      <div className={Classes.story}>
        <h4 className="font-satoshi">Our Story</h4>
        <Image
          // src="/story.png"
        ...
        <div className={Classes.storyFlex}>
          <p className="font-satoshi">
            Prooval was born from a simple truth, talented professionals
            shouldn't have to struggle to share their expertise or earn from
            what they know.
          </p>
        </div>
        <p className="-mt-[119px] mb-[15px] font-satoshi">
          We saw how experts, coaches, consultants, mentors, and creators were
          forced to juggle multiple platforms just to host sessions, sell
          products, or get paid. It was messy, time-consuming, and often
          discouraging. So, we set out to change that.
        </p>
        <p className="font-satoshi">
          Prooval was built to make it easy for professionals to do what they do
          best, teach, guide, create, and inspire without the tech headaches.
          From a single link, you can make an impact and generate more income,
          you can host live sessions, sell digital products, and connect with
          your audience.
        </p>
      </div>
      <div>
        <div className="text-center mt-[140px] md:mt-[49px]  mb-[148px] md:mb-[48px] sm:[24px] font-satoshi">
      ...
      <section className="w-full flex font-satoshi justify-center items-center pt-[40px] px-[80px] md:px-[40px] xl:px-[25px] xm:px-[16px] sm:px-[16px] ">
        <div className="relative w-full bg-[#0057FF] rounded-[24px] text-center text-white overflow-hidden bg-[url(/Stroke_1.svg)] bg-cover bg-center">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center pt-[114.5px] pb-[80px]">
            <div className="w-[609px] max-w-full sm:w-[300px]">
              <h1 className="text-[48px] text-[#FCFCFC] font-bold mb-2 leading-[56px] sm:text-[20px] sm:leading-[32px] font-satoshi">
              ...
              <p className="text-base text-[#FCFCFC] leading-[160%] mb-8 sm:text-[14px]">
                When you share what you know, it becomes easier for more people
                to learn, grow, and thrive.
              </p>
            </div>

            <button className="bg-[#ffffff] text-[#1453FF] font-medium px-6 py-3 w-[300px] sm:w-[218px] rounded-md hover:bg-gray-100 transition font-satoshi">
              Create my Page
            </button>
          </div>
        </div>
