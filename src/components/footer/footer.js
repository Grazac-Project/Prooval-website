        ...
        <div className='flex  justify-between sm:justify-center xm:justify-start sm:flex-wrap sm:flex-col-reverse bg-[#0A1A2A] px-[120px] xl:px-[80px] lg:pl-[60px] md:pl-[25px] lg:pr-[30px] pt-[86px] xl:pt-[66px] md:pt-[40px] mb-[168px] sm:mb-[29px] text-[#fff]'>
            <div className=''>
                ...
                <p className='h-8 flex gap-4 mt-[10px]'>
                    ...
                    <Image src='/youtube.png' width={32} height={32} alt='youtube logo' />
                    <Image src='/twitter.png' width={32} height={32} alt='twitter logo' />
                </p>
                <div className='flex pt-[64px] sm:pt-[32px] gap-2 sm:gap-[111px] xm:gap-[50px] '>
                    <ul>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max '>About us</li>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max my-[16px]'>How it works</li>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max mb-[16px]'>Privacy Policy</li>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max'>Jobs</li>
                    </ul>
                    <ul className=''>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max'>Terms & Conditions</li>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max my-[16px]'>Contact us</li>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max mb-[16px]'>FAQs</li>
                        <li className='font-mont text-base xl:text-sm font-medium xl:font-normal w-max'>Testimonies</li>
                    </ul>
                </div>
            ...
            <div className='w-[750px] xl:w-[600px] lg:w-[500px] md:w-[350px] xm:w-[100%]'>
                ...
                <button className='bg-[#005F70] font-mont text-[18px] leading-[21.94px] font-medium text-[#fff] p-[10px] w-[277px] xm:w-[100%] h-[56px] lg:h-[48px] rounded-lg mt-6 mb-[64px] lg:mb-[20px] sm:mb-[64px]'>Start now</button>
