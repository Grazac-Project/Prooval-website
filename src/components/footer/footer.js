      ...
      <div className="flex sm:flex-col justify-between sm:gap-[32px]">
        ...
        <div className="order-1">
          ...
          <form className="flex xm:block gap-[6px]" onSubmit={handleSubmit}>
            ...
            <input type="text" id='fullName' placeholder="Enter your full name" value={values.fullName} onChange={handleChange} className="w-[208px] h-[44px] md:w-[150px] xm:w-[100%] xm:mb-[8px] px-[14px] font-regular text-[14px] leading-[40.8px] text-[rgba(102, 112, 133, 1)] rounded-[8px] border-[1px] border-[#D0D5DD] shadow-footerInput" />
            ...
            <input type="text" id='email' placeholder="Enter your email" value={values.email} onChange={handleChange} className="w-[208px] h-[44px] md:w-[150px] xm:w-[100%] xm:mb-[8px] px-[14px] font-regular text-lg leading-[40.8px] text-[rgba(102, 112, 133, 1)] rounded-[8px] border-[1px] border-[#D0D5DD]" />
