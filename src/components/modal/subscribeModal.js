  ...
  return (
    ...
    <section className="font-onest">
      ...
      <div
        ...
        className="modal w-[588px] sm:w-[343px] xm:w-[90%]  md:w-[90%] h-fit py-[21px] mx-auto bg-[#fff] rounded-[16px] border-solid border-[1px] border-[#fff] z-[9900] absolute left-[calc(25%)] xl:left-[calc(17%)] lg:left-[calc(14%)] md:left-[calc(5%)] sm:left-[calc(19%)] xm:left-[calc(10%)] xxxm:left-[calc(7%)]"
      >
        <div className="flex justify-center items-center gap-[2px] mb-[8px]">
          <RiVerifiedBadgeFill className="text-[#13AD61] text-[24px]" />
          <h4 className="font-medium font-bold text-[24px] leading-[36px] text-[#1C1C1C] text-center">
            Thank you!
          </h4>
        </div>
        ...
        <span
          className="text-[24px] absolute top-[21px] xxm:top-3 right-[20px] text-[#373737] z-[10001] cursor-pointer"
          onClick={close}
        >
          &times;
        </span>
