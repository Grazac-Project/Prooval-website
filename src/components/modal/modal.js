...
const Modal = ({modalClose}) => {
  ...
  return (
    ...
    <section className='font-whyte'>
        ...
        <div style={{top: topModalPosition + 'px'}} className='modal w-[588px] sm:w-[343px] ssxm:w-[90%]  md:w-[90%] h-[108px] py-[21px] mx-auto bg-[#fff] rounded-[16px] border-solid border-[1px] border-[#fff] z-[9900] absolute left-[calc(25%)] xl:left-[calc(17%)] lg:left-[calc(14%)] md:left-[calc(5%)] sm:left-[calc(19%)] xm:left-[calc(10%)] xxxm:left-[calc(7%)]'>
            ...
            <p className='font-regular text-[20px] sm:text-[16px] leading-[30px] sm:leading-[19.2px] text-[#667085] text-center'>We have added you to the mailing list</p>
